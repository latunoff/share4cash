...
define('TPL_PATH','/cp/templates/'.SITE_TPL.'/');
...
define('_SID_NAME_', PREF.'admin');
define('_SSID_NAME_', PREF.'admin_sid');
...
define('BACK_URL', $referer);

define('ENTER_SID', rand(111111, 999999));
require_once(CORE_PATH.'cp/modules/enter_do.php');
